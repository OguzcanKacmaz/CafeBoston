...
namespace CafeBoston.UI
{
    ...
    public partial class OrderForm : Form
    {
        ...
        public OrderForm(CafeData db, Order order)
        {
            ...
            InitializeComponent();
            dgwOrderDetails.DataSource = _orderDetails;
            LoadProducts();
            UpdateTableInfo();
        }
        ...
        {
            cboTableNo.DataSource = Enumerable.Range(1, _db.TableCount).Where(x => !_db.ActiveOrders.Any(o => o.TableNo == x)).ToList();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (orderDetail == null)
            {
                _orderDetails.Add(new OrderDetail() { ProductName = product.ProductName, Quantity = (int)nudQuantitiy.Value, UnitPrice = product.UnitPrice });
            }
            else
            {
                orderDetail.Quantity += (int)nudQuantitiy.Value;
