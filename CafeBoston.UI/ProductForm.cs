...
namespace CafeBoston.UI
{
    public partial class ProductForm : Form
    {
        ...
        public ProductForm(CafeData db)
        {
            ...
            InitializeComponent();
            dgwProducts.DataSource = _products;
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (_edited == null)
            {
                _products.Add(new Product() { ProductName = productName, UnitPrice = unitPrice });
            }
            else
            {
                _edited.ProductName = productName;
                _edited.UnitPrice = unitPrice;
                _products.ResetBindings();
            }
            SwitchToAddMode();
        }

        private void dgwProducts_UserDeletingRow(object sender, DataGridViewRowCancelEventArgs e)
        {
        ...
        {
            if (dgwProducts.SelectedRows.Count != 1) return;
        ...
        private void SwitchToEditMode()
        {
            ...
            btnCancel.Show();
            btnAdd.Text = "SAVE";
            _edited = (Product)dgwProducts.SelectedRows[0].DataBoundItem;
